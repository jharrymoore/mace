# Implements the HAL idea from CAS - essentially biased MD towards
# So, do some initial training of the committee of models, then start running MD with the biased potential


# Both the ASE and OpenMM calculators have ensemble versions that will return stdev

# This should contain the initialization code from the regular train script, then initialzie the test system and start propagating the trajectory, with the capability to add a biasing term to the returned energies, controlled by \tau
